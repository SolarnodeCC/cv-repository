...
class Page(BaseModelWithoutExtraKeys):
    size: PageSize = pydantic.Field(
        ...
        description=(
            ...
            " standard). The default value is `a4`."
        ),
    )
    top_margin: TypstDimension = pydantic.Field(
        default="1.4cm",
        description=length_common_description + " The default value is `1.4cm`.",
    )
...
class Colors(BaseModelWithoutExtraKeys):
    ...
    name: Color = pydantic.Field(
        default=Color("rgb(15, 48, 80)"),
        description=color_common_description
        + " The default value is `rgb(15, 48, 80)`.",
        examples=color_common_examples,
    )
...
class SolarnodeTheme(BaseModelWithoutExtraKeys):
    theme: Literal["solarnode"] = "solarnode"
